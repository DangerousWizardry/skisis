...
<body class="admin">
<nav class="admin"><div class="logo"><img src="../assets/ski.png">SKISIS</div><div><a href="">Home</a></div><div><a href="">Edition Catégorie</a></div><div><a href="">Edition Produit</a></div></nav>
...
<script>
	$( "#slider-range" ).slider({
	  ...
	  create: function( event, ui ) {
		  from = new Date(${firstAndLastOrderDate[0]});
		  to = new Date(${firstAndLastOrderDate[1]});
