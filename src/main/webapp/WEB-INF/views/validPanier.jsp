...
<html>
    ...
    <body class="validPanier">
        ...
        <div class="content">
            <h1>Informations</h1>
            <div><form><label>Nom du destinataire</label><input type="text" name="destinataire" value="${client.contact}">
            ...
            <input type="button" name="valider" value="Valider la commande"></form></div>
        </div>
    </body>
</html>
